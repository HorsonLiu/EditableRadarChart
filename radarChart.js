...
function RadarChart(id, axes, data, options, onEdit) {
    ...
    axisGrid.selectAll(".levels")
        ...
        .style("fill", "#CDCDCD")
        .style("stroke", "#CDCDCD")
        .style("fill-opacity", cfg.backgroundOpacity)
    ...
    var modelWrapper = g.selectAll(".radarWrapper")
        .data(data)
        .enter().append("g")
    ...
    function move(dobj, axisIndex, modelIndex) {
        ...
        g.select("#radarArea" + modelIndex)
            .attr("d", radarLine(data[modelIndex]));

        g.select("#radarStroke" + modelIndex)
            .attr("d", radarLine(data[modelIndex]));
    ...
    modelWrapper.selectAll(".radarVertex")
        .data(function (d, i) {
            return d;
        })
        .enter().append("circle")
        .attr("class", "radarVertex")
